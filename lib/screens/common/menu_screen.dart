        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Title / subtitle
              Center(
                  child: Text('Smart Games',
                      style: AppTheme.titleTextStyle(context))),
              SizedBox(
                  height:
                      ResponsiveConfig.spacing(context, size: SpacingSize.xxs)),
              Center(
                  child: Text("Let's train your brain today!",
              ...
              Center(
                child: IconButton(
                  ...
                  iconSize:
                      ResponsiveConfig.iconSize(context, size: IconSize.xl),
